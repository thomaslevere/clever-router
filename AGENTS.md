...
export APP_ENV=dev
export ALLOWED_IMAGES="diegosouzapw/omniroute:latest,decolua/9router:latest,ghcr.io/decolua/9router:latest,9router/9router:latest,tashfeenahmed/freellmapi:latest,ghcr.io/tashfeenahmed/freellmapi:latest"
