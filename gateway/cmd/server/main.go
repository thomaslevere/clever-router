...
func main() {
	...
	// Adapter registry (OmniRoute + 9Router + FreeLLMAPI + LiteLLM + New-API + Portkey + Bifrost + CoAI + LLMGateway + OpenConnector)
	reg := adapters.NewRegistry(adapters.OmniRouteAdapter{}, adapters.NineRouterAdapter{}, adapters.FreeLLMAPIAdapter{}, adapters.LiteLLMAdapter{}, adapters.NewApiAdapter{}, adapters.PortkeyAdapter{}, adapters.BifrostAdapter{}, adapters.CoAIAdapter{}, adapters.LLMGatewayAdapter{}, adapters.OpenConnectorAdapter{})
