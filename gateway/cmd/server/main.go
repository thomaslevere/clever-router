...
func main() {
	...
	// Adapter registry (OmniRoute + 9Router + FreeLLMAPI + LiteLLM)
	reg := adapters.NewRegistry(adapters.OmniRouteAdapter{}, adapters.NineRouterAdapter{}, adapters.FreeLLMAPIAdapter{}, adapters.LiteLLMAdapter{})
