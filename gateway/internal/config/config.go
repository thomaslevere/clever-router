...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		AllowedImages:     splitCSV(getenv("ALLOWED_IMAGES", "diegosouzapw/omniroute:latest,ghcr.io/berriai/litellm:main-stable,ghcr.io/berriai/litellm:main-latest,ghcr.io/berriai/litellm:latest,berriai/litellm:main-stable,berriai/litellm:main-latest,berriai/litellm:latest,decolua/9router:latest,ghcr.io/decolua/9router:latest,9router/9router:latest,tashfeenahmed/freellmapi:latest,ghcr.io/tashfeenahmed/freellmapi:latest,freellmapi/freellmapi:latest")),
