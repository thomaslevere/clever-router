...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		AllowedImages:     splitCSV(getenv("ALLOWED_IMAGES", "diegosouzapw/omniroute:latest,ghcr.io/berriai/litellm:main-stable,ghcr.io/berriai/litellm:main-latest,ghcr.io/berriai/litellm:latest,berriai/litellm:main-stable,berriai/litellm:main-latest,berriai/litellm:latest,decolua/9router:latest,ghcr.io/decolua/9router:latest,9router/9router:latest,tashfeenahmed/freellmapi:latest,ghcr.io/tashfeenahmed/freellmapi:latest,freellmapi/freellmapi:latest,calciumion/new-api:latest,ghcr.io/quantumnous/new-api:latest,quantumnous/new-api:latest,new-api/new-api:latest,portkeyai/gateway:latest,ghcr.io/portkey-ai/gateway:latest,portkey-ai/gateway:latest,maximhq/bifrost:latest,ghcr.io/maximhq/bifrost:latest,bifrost/bifrost:latest,coaidev/coai:latest,ghcr.io/coaidev/coai:latest,coai/coai:latest,programzmh/chatnio:latest,programzmh/chatnio:stable,programzmh/chatnio,chatnio/chatnio:latest,chatnio/chatnio,ghcr.io/theopenco/llmgateway-unified:latest,theopenco/llmgateway:latest,ghcr.io/theopenco/llmgateway:latest,llmgateway/llmgateway:latest,ghcr.io/oomol-lab/open-connector:latest,oomol-lab/open-connector:latest,open-connector:latest,oomol/open-connector:latest")),
